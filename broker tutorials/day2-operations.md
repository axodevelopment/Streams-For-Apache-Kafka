...
| Task | Description |
| Pod Management - Rolling Update | Strimzi exposes annotations on strimzipodsets that allow you to trigger management activities |
| Scaling Clusters | How to Scale clusters |
| Rebalacning Clusters | Cruise Control can be used Rebalance Cluster what does that imply and what are some restrictions |